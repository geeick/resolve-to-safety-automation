...
Run safe review:
    py create_shift_reports_from_resolve_v9.py

Test one shift report only:
    py create_shift_reports_from_resolve_v9.py --only-shift-location "100 Venice Way"

Test one shift report and open SafetyPark after confirmation:
    py create_shift_reports_from_resolve_v9.py --only-shift-location "100 Venice Way" --open-safetypark

Run using already-downloaded CSV:
    py create_shift_reports_from_resolve_v9.py --csv "resolve_scantopay_yesterday.csv"

Run and open SafetyPark after confirmation:
    py create_shift_reports_from_resolve_v9.py --open-safetypark

Date override:
    py create_shift_reports_from_resolve_v9.py --date 2026-06-18
"""
